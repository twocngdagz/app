    ...
    function Scroller(elem, settings) {
        ...
        function scrollToPos(time, index, manual, dir, active) {
            ...
            if (event('validate', [dw, index, time]) !== false) {
                ...
                if (s.display == 'inline' || s.display == 'bubble') {
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="' + s.theme + ' dw-' + s.display + (prefix ? ' dw' + prefix : '') + '">' + (s.display == 'inline' || s.display == "bubble" ? '<div class="dw dwbg dwi">'+((s.display=="bubble")?'<div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div>':'')+'<div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '<div class="dwv"></div>' : '')) + '<div class="dwcc">';
            ...
            html += '</div>' + ((s.display != 'inline' && s.display != 'bubble' )? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s"><span class="dwb dwb-e">' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"><span class="dwb dwb-e">' + s.button3Text + '</span></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb dwb-e">' + s.cancelText + '</span></span></div></div>' : '') + '</div></div></div>';
            dw = $(html);
        ...
        */
        that.init = function (ss) {
            ...
            if (s.display == 'inline') {
                ...
                elm.bind('focus', function () { that.show(); });
				elm.keyup(function(){
					try{
					if(elm.val().length == 4 && !isNaN(elm.val()))
						elm.val(elm.val().substr(0,2)+":"+elm.val().substr(2,2));
						elm.mobiscroll("setDate",Date.parse(elm.val()),false);
					} catch (e){}
				});
            } 
			else {
        ...
        that.destroy = function () {
 		...
 		elm.blur(function () { 
			if(elm.val().length>0 && elm.val() != "00:00" && elm.val()  !="__:__")
			{	
